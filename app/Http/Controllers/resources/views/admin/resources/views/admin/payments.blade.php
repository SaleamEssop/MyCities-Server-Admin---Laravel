                    ...
                    <table class="table table-bordered" id="payments-dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($payments as $payment)
                            <tr>
                                ...
                                <td>{{ $payment->notes }}</td>
                                <td>
                                    <a href="{{ url('admin/payments/delete/'.$payment->id) }}" onclick="return confirm('Are you sure you want to delete this payment?')" class="btn btn-danger btn-circle btn-sm">
