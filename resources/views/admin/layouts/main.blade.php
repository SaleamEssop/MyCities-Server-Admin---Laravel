    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('admin/') }}">
                <img src="{{ \Illuminate\Support\Facades\URL::to(\Illuminate\Support\Facades\Storage::url('public/images/logo.PNG')) }}"
                    alt="logo-img" width="100%" />
            </a>
            ...
            @if (auth()->user()->is_property_manager === 1)
                ...
                @php
                    $properties = \App\Models\Property::where('property_manager_id', auth()->user()->id)->get();
                @endphp

                @foreach ($properties as $property)
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="{{ route('show-property', $property->id) }}">
            ...
            @elseif ((auth()->user()->is_super_admin === 1))
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseProperties" class="collapse" aria-labelledby="headingProperties"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded cust-sidebar-bg">
                                <a class="collapse-item cust-sidebar-sub" href="{{ route('properties-list') }}">List</a>
                                <a class="collapse-item cust-sidebar-sub" href="{{ route('create-property') }}">Add</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseAds" class="collapse" aria-labelledby="headingUtilities"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="{{ route('permissions-list') }}">List</a>
                                <a class="collapse-item" href="{{ route('ads-list') }}">Ads</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                            data-target="#collapseRegions" aria-expanded="true" aria-controls="collapseRegions">
                            <i class="fas fa-fw fa-location-arrow"></i>
                            <span>Regions Management</span>
                        </a>
                        <div id="collapseRegions" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded cust-sidebar-bg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                            data-target="#collapseAccountType" aria-expanded="true" aria-controls="collapseAccountType">
                            <i class="fas fa-fw fa-location-arrow"></i>
                            <span>AccountType</span>
                        </a>
                        <div id="collapseAccountType" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded cust-sidebar-bg">
                                <a class="collapse-item cust-sidebar-sub"
                                    href="{{ route('account-type-list') }}">List</a>
                                <a class="collapse-item cust-sidebar-sub"
                                    href="{{ route('add-account-type-form') }}">Add</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                            data-target="#collapseRegionsCost" aria-expanded="true" aria-controls="collapseRegionsCost">
                            <i class="fas fa-fw fa-location-arrow"></i>
                            <span>Regions Cost</span>
                        </a>
                        <div id="collapseRegionsCost" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded cust-sidebar-bg">
                                <a class="collapse-item cust-sidebar-sub" href="{{ route('region-cost') }}">List</a>
                                <a class="collapse-item cust-sidebar-sub"
                                    href="{{ route('region-cost-create') }}">Add</a>
                            </div>
                        </div>
                    </li>
                ...
                <div class="cust-alert-wrapper">
                    @if (\Illuminate\Support\Facades\Session::has('alert-message'))
                        <p class="alert {{ \Illuminate\Support\Facades\Session::get('alert-class', 'alert-info') }}">
                            {{ \Illuminate\Support\Facades\Session::get('alert-message') }}</p>
                    @endif
                </div>
                @yield('content')
            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            flatpickr(".payment_date", {
                ...
                altInput: true,
                altFormat: "m/d/Y",  // Optional: alternate display format (mm/dd/yyyy)
                allowInput: true, 
