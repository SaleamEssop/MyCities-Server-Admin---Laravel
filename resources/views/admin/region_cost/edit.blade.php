                ...
                <form method="POST" action="{{ route('update-region-cost') }}">
                        ...
                        <div class="waterin-additional-cost-container"></div>
                         ...
                         <div class="row mt-2">
                            <div class="col-md-2 offset-md-10">
                                ...
                                <input class="form-control" type="text" placeholder="Total" name="waterin_related_total" value="{{$region_cost->water_in_related_total ?? 0}}" required disabled />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="water_out_section">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-2 offset-md-10">
                                ...
                                <input class="form-control" type="text" placeholder="Total" name="waterout_related_total" value="{{$region_cost->water_out_related_total ?? 0}}" required disabled />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ele_section">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-2 offset-md-10">
                                ...
                                <input class="form-control" type="text" placeholder="Total" name="electricity_related_total" value="{{$region_cost->electricity_related_total ?? 0}}" required disabled />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 ml-auto">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" placeholder="VAT Amount" name="vat_amount" value="{{$region_cost->sub_total_vat ?? 0}}" required disabled />
                            </div>
                            <label><strong>Rates :</strong></label>
                            <div class="form-group">
                                <input class="form-control allow_decimal" type="text" placeholder="Rates" name="vat_rate" value="{{$region_cost->vat_rate ?? 0}}" required />
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function calculateAllTotals() {
            ...
            // Get Rates (vat_rate) and Rates Rebate
        ...
        $(document).on('input', 'input[name^="additional["]', function() {
            calculateAllTotals();
        });
